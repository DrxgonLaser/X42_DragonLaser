...
const TOOLS = [
  ...
  { name: 'Embergen', icon: '/resources/Icons/embergen.webp', desc: 'Real-time volumetric fluid, smoke, and fire simulations.' },
  { name: 'Gaea', icon: '/resources/Icons/gaea.webp', desc: 'Advanced procedural terrain generation and thermal erosion.' },
